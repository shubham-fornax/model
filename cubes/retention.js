...
cube(`retention`, {
    ...
    joins: {
      dim_customer_profile_for_retention: {
        relationship: `many_to_one`,
        sql: `cast(${CUBE}.customer_id as string) = ${dim_customer_profile_for_retention.customer_id}`,
        },

      dim_products_for_retention: {
        relationship: `many_to_one`,
        sql: `cast(${CUBE}.sku_name as string) = ${dim_products_for_retention.sku}`
      },
//
      dim_date_orders: {
        relationship: `many_to_one`,
...
//
      ...
      first_order_date: {
        sql: `${dim_customer_profile_for_retention.first_order_date}` ,
      ...
      sku: {
        sql: `${dim_products_for_retention.sku}` ,
        type: `string` ,
      },

      product_name: {
        sql: `${dim_products_for_retention.product_name}` ,
        description: ` The name of the product.`,
        type: `string` ,
      },

      category: {
        sql: `${dim_products_for_retention.category}` ,
